...
import com.example.michan.myuts.VideoPlayActivity;
...
public class VideoActivity extends AppCompatActivity
{
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                cursor = db.rawQuery("SELECT * FROM video", null);
                adapter = new SimpleCursorAdapter(this, R.layout. lv_video, cursor, new String[]
    ...
    public void search_db(View v)
    {
        ...
        if (!edit_db.equals(""))
        {
            try
            {
                cursor = db.rawQuery("SELECT * FROM video WHERE nama LIKE ?", new String[]{"%" +edit_db+"%"});
                adapter = new SimpleCursorAdapter(this, R.layout.lv_video, cursor, new String[]
                        {"nama"}, new int[]{R.id.lvtextmin});
